...
// button comp comes from shadcn  UI 
import {
  TwitterIcon,
  InstagramIcon,
  LinkedinIcon,
...
export default function Home() {
  const { userId } = auth();
  /// get the userID from useAuth() hook 
  return (
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Create engaging content for  Instagram, LinkedIn and Twitter with
            cutting-edge AI technology.
          </p>
          <div className="flex justify-center space-x-4">
            {/* Inbuuild Button component is taken from shadcn ui*/}
            <Button
              asChild
            ...
            >
              ...
              {/* navigate to generate page if user clicks Start Creating*/}
            </Button>
            <Button
              asChild
            ...
            </Button>  {/*Navigate to features page if user clciks on Learn More */}
          </div>
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                ...
                "Analyze performance with detailed insights and metrics",
                "Seamlessly Integrate with Your favourite marketing tools"
              ].map((benefit, index) => (
        ...
        {/* CTA Section call to action section this allows users to take a specific action here it buy subscription and generater AI content*/}
        <div className="text-center py-20 relative">
          ...
          {userId ? (
            ...
            >
              <Link href="/generate">
                Generate AI Content Now <ArrowRightIcon className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          ) : (
